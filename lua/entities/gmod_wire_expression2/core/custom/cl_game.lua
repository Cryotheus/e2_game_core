...
local function_descriptions = {
	["gameCameraAng"] =							{3, "Sets the camera's angle."},
	["gameCameraCreate(n)"] =					{3, "Creates a camera with the specified index. The camera will be removed when the game is closed."},
	["gameCameraCreate(nv)"] =					{3, "Creates a camera with the specified index and position. The camera will be removed when the game is closed."},
	["gameCameraCreate(nva)"] =					{3, "Creates a camera with the specified index, position, and angle. The camera will be removed when the game is closed."},
	["gameCameraEntity"] =						{3, "Returns the camera's entity."},
	["gameCameraFOV"] =							{3, "Sets the camera's field of view."},
	["gameCameraLerp(nnv)"] =					{3, "Moves the camera to the end_position using linear interpolation."},
	["gameCameraLerp(nnvv)"] =					{3, "Moves the camera to the end_position from the start_position using linear interpolation."},
	["gameCameraLerpBezier"] =					{3, "Moves the camera to the along a bezier curve."},
	["gameCameraParent(ne)"] =					{3, "Parents the camera the entity."},
	["gameCameraPos"] =							{3, "Sets the camera's position."},
	["gameCameraRemove"] =						{3, "Removes the camera."},
	["gameCameraRemoveAll"] =					{3, "Removes all cameras."},
	["gameCameraUnparent"] =					{3, "Unparents the camera."},
	...
	["gamePlayerApplyForce"] =					{5, "Applies force to the player according to the given vector's direction and magnitude."},
	...
	["gamePlayerGiveWeapon(s)"] =				{3, 'Gives all players the weapon by the class name, the weapon will not have ammo in reserve or clip. Will return the weapon on success, and "noentity" on fail.'},
	...
	["gamePlayerGiveWeapon(sn)"] =				{3, 'Gives all players the weapon by the class name, the weapon will not have ammo in reserve, and will only have a full clip (and sometimes reserve ammo) if give_ammo is non-zero. Will return the weapon on success, and "noentity" on fail.'},
	["gamePlayerGiveWeapon(e:sn)"] =			{5, 'Gives the player the weapon by the class name, the weapon will not have ammo in reserve, and will only have a full clip (and sometimes reserve ammo) if give_ammo is non-zero. Will return the weapon on success, and "noentity" on fail.'},
	["gamePlayerKill"] =						{3, "Kills all players in the game."},
	["gamePlayerKill(e:)"] =					{5, "Kills the player."},
	...
	["gamePlayerSetCamera(e:)"] =				{5, "Restores the player's view if they were in a camera."},
	["gamePlayerSetCamera(e:n)"] =				{5, "Sets the player's view to the camera."},
	...
	["gameSetDefaultRespawnDelay"] =			{3, "Sets the respawn delay for the GAMERESPAWNMODE_DELAYED respawn mode."},
	["gameSetDefaultRespawnMode"] =				{3, "Sets the respawn mode using a GAMERESPAWNMODE enum."},
