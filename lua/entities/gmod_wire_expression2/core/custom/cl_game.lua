...
local function_descriptions = {
	...
	["gamePlayerGiveWeapon(e:sn)"] =			{5, 'Gives the player the weapon by the class name, the weapon will not have ammo in reserve, and will only have a clip if fill_clip is non-zero. Will return the weapon on success, and "noentity" on fail.'},
	...
	["gamePlayerRespawn"] =						{5, "Respawns the specified player."},
